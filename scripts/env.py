...
RPC_ENV_ALIASES: dict[str, tuple[str, ...]] = {
    "1": ("PROVIDER_URL_MAINNET", "PROVIDER_URL_MAINNET_1", "RPC_1", "RPC_2"),
    "10": ("PROVIDER_URL_OPTIMISM",),
    "137": ("PROVIDER_URL_POLYGON",),
    "42161": ("PROVIDER_URL_ARBITRUM", "PROVIDER_URL_ARBITRUM_2", "RPC_42161"),
    "8453": ("PROVIDER_URL_BASE", "RPC_8453"),
}

EXPLORER_API_KEY_ALIASES: dict[str, tuple[str, ...]] = {
    "ETHERSCAN_API_KEY": ("ETHERSCAN_TOKEN", "ETHERSCAN_API_KEY"),
