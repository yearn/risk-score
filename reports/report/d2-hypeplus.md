...
- [Strategy Contract List](https://gitbook.d2.finance/security-and-contracts/smart-contracts/strategy-contracts.md)
- [D2 Multisig List](https://gitbook.d2.finance/security-and-contracts/smart-contracts/d2-multi-sigs.md)
...
| Vault Owner | [`0x0E8c0470773c65498F438cac380648B314399A46`](https://arbiscan.io/address/0x0E8c0470773c65498F438cac380648B314399A46) | EOA on-chain (team states institutional MPC/HSM custody); owns BOTH HYPE++ vault and dgnHYPE vault |
| Trader Admin / Executor / Fee Receiver | [`0x7ab129978091DEE65A319c5FC728818D73221999`](https://arbiscan.io/address/0x7ab129978091DEE65A319c5FC728818D73221999) | EOA on-chain (team states institutional MPC/HSM custody); holds `DEFAULT_ADMIN_ROLE` and `EXECUTOR_ROLE` on trader |
...
- HYPE++ trader [`0x8CaB...45B3`](https://arbiscan.io/address/0x8CaBD8b787e8c69C5f24091cFDA197fF570345B3)
  ...
  - The trader uses solidstate `AccessControl` (not enumerable); `getRoleMemberCount` and `getRoleMember` are unavailable. Monitor `RoleGranted`/`RoleRevoked` events for role-holder enumeration.
  ...
  - Note: `setFeeReceiver()` and fee-rate changes go through `setFeeRates(uint256,uint256)` (both gated by `DEFAULT_ADMIN_ROLE`, verified onchain).
