...
| GhoRouter deployment status | **Not deployed.** [PR #34](https://github.com/aave-dao/gho-origin/pull/34) open (unmerged, last commit 2026-06-29), no `GHO_ROUTER` in the Address Book, no router payload in `aave-proposals-v3`. TokenLogic was reimbursed 11,655 aEthLidoGHO for a *GhoRouter audit* in [AIP 492](https://github.com/aave-dao/aave-proposals-reports/blob/main/reports/v3-492-aave-v3-MayJune-2026-Funding-Update.md), so an audit has been commissioned but no report is public | [PR #34](https://github.com/aave-dao/gho-origin/pull/34), [AIP 492 report](https://github.com/aave-dao/aave-proposals-reports/blob/main/reports/v3-492-aave-v3-MayJune-2026-Funding-Update.md) |
