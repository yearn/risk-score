...
- **Updated:** June 17, 2026 — team-feedback reassessment: corrected loss waterfall / attachment points, reUSDe tranche label and yield, reUSD yield mechanism, issuer entity, premium/portfolio figures, underwriting leadership, reserve attribution, and the Chainlink Proof-of-Reserve finding (a live PoR feed was confirmed on Avalanche). Onchain reserve **balances** were not re-snapshotted; reserve **totals** were recomputed only to exclude a reclassified (reUSDe) custodian.
