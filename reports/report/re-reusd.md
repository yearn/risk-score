...
- **Final Score: 3.4/5.0** (was 3.6; verified governance improvements reduce centralization risk — tempered for role-regrant reversibility; see Risk Score Assessment)
...
**Funds Management Score = (4.0 + 3.75) / 2 = 3.875**

**Score: 3.875/5** (was 4.0) -- Hybrid model with meaningful offchain components. Three plain EOAs hold ~86% of onchain reserves with no onchain outflow restriction (custody risk remains the primary concern, unchanged since April). Core reserve provability relies on offchain attestation with no independent onchain oracle. The EOA oracle-bypass closure and MINTER_ROLE holder reduction are material (if re-openable) improvements; Collateralization is unchanged at 4.0 because the dominant fund-loss vector (the reserve-custody EOAs) did not change.
...
**Final Score: 3.4** (3.4375 rounded; was 3.6 in April 2026)
