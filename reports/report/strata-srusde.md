...
| August 5, 2026 | 2.10 | [#351](https://github.com/yearn/risk-score/pull/351) | Reassessment: TVL ~$75.8M, ~76% below ATH (fourth drawdown to $50.5M on Jul 15). Coverage 111.2%, junior/senior ratio 11.23%. Senior redemption confirmed atomic in sUSDe (`sUSDeCooldownSrt` = 0) and ~1 day in USDe after Ethena cut its cooldown to 1 day in Mar 2026 — Liquidity 3.0→2.0. Pendle liquidity $4.60M; DEX ~$80.3K; no srUSDe/USDC Morpho market exists. Sixth market (Hastra PRIME) live. Issue [#379](https://github.com/yearn/risk-score/issues/379) follow-up: active $250K Immunefi bounty and public Frontera Labs contributors verified — Audits & Historical 3.0→2.25, Operational 2.5→2.0. Benchmark rate resolves through a live Aave read rather than manual pushes: Programmability 2.5→2.0. Ethena treated as intended underlying exposure with junior first-loss buffer in collateralization. Tier moves Medium → Low. |
