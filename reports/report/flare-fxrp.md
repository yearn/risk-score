...
|-------------|----------|-------|--------|
| Base (30184) | [`0xCE6170EA245dC8D1f275A710a062b70f125F0110`](https://basescan.org/address/0xCE6170EA245dC8D1f275A710a062b70f125F0110) | 6-of-11 Safe [`0x42D6…67D3`](https://basescan.org/address/0x42D660C6C871a9176cEb102E9ad9722459Aa67D3) (same address as Ethereum) | 524,489.635409 |
...
- **The mesh is governed by one signer set.** The Ethereum OFT and its ProxyAdmin, the Flare adapter, and the Katana, HyperEVM, Monad, Base, and BNB OFTs are all owned by 6-of-11 Safes sharing the **identical 11 owner addresses** (verified onchain on each chain). None has a timelock. This concentrates rather than diversifies: a single signer-set compromise reaches every deployment on all six chains simultaneously, and the weakest-governed chain sets the effective security of Ethereum FXRP. The escrow-vs-remote-supply reconciliation would detect such an event, but only after the fact.
