...
4 -> Contracts owner is a multisig but the addresses are not known/hidden `OR` Contracts owner can harm our strategy by setting parameters in external prot contracts up to some degree
